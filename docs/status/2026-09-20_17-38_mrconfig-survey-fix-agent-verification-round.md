...
_(35 grounded items; padding to 50 would be speculation.)_
...
_Point-in-time snapshot of this session only. The fix plan (`~/backups/ecology/fix-plan-2026-09-20.md`, Appendix C) is the living counterpart; concurrent-session changes in this repo's working tree were observed and left alone._
