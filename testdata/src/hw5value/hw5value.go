...
func (d *DeadCheck) HealthCheck(context.Context) error { return nil } // want HealthCheck:`nil-body health check`
...
func (c *ClosureCreated) HealthCheck(context.Context) error { return nil } // want HealthCheck:`nil-body health check`
